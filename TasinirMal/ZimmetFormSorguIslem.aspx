<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZimmetFormSorguIslem.aspx.cs" Inherits="TasinirMal.ZimmetFormSorguIslem" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function DegerAt(yil, muhasebeKod, harcamaBirimKod, fisNo, islem, belgeTur)
        {
            ...
            document.getElementById('txtBelgeTur').value=belgeTur;
        }
