<%@ Page Language="C#" CodeBehind="TanimIl.aspx.cs" Inherits="TasinirMal.TanimIl" %>
                ...
                <ext:Panel ID="tabPanelAna" runat="server" Region="Center" StyleSpec="background-color:white;padding:10px"
                    ...
                    <Items>
                        <ext:GridPanel ID="grdListe" runat="server" StripeRows="true" Header="false" TrackMouseOver="true"
                            ...
                            <ColumnModel ID="ColumnModel1" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ColumnID="KOD" DataIndex="KOD" Width="50"
                                        Header="Kodu" />
                        ...
                        <ext:FormPanel ID="pnlTanim" runat="server" Region="Center" Padding="10">
                            ...
                            <Items>
                                <ext:TextField ID="txtKod" runat="server" FieldLabel="<%$Resources:TasinirMal,FRMTIL009%>" Width="130" />
                                <ext:TextField ID="txtAd" runat="server" FieldLabel="<%$Resources:TasinirMal,FRMTIL010 %>" Width="130" />
                            </Items>
                        </ext:FormPanel>
                    </Items>
                </ext:Panel>
