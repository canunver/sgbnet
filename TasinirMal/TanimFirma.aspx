<%@ Page Language="C#" CodeBehind="TanimFirma.aspx.cs" Inherits="TasinirMal.TanimFirma" %>
            ...
            <Reader>
                <ext:JsonReader>
                    <Fields>
                        ...
                        <ext:RecordField Name="KULLANICIKODU" />
                        <ext:RecordField Name="ADI" />
                        <ext:RecordField Name="VNO" />
                        <ext:RecordField Name="VD" />
                        <ext:RecordField Name="BANKA" />
                        <ext:RecordField Name="HESAPNO" />
                        <ext:RecordField Name="TEL" />
                        <ext:RecordField Name="FAKS" />
                    </Fields>
                </ext:JsonReader>
            </Reader>
        </ext:Store>
                    ...
                    <Items>
                        <ext:GridPanel ID="grdListe" runat="server" StripeRows="true" Header="false" TrackMouseOver="true"
                            ...
                            <ColumnModel ID="ColumnModel1" runat="server">
                                <Columns>
                                    <ext:Column ColumnID="AD" DataIndex="ADI" Header="Adı" />
                                </Columns>
                            </ColumnModel>
                            <SelectionModel>
                        ...
                        <ext:FormPanel ID="pnlTanim" runat="server" Region="Center" Padding="10" LabelWidth="150">
                            ...
                            <Items>
                                <ext:TextField ID="txtAd" runat="server" FieldLabel="<%$Resources:TasinirMal,FRMTFR007 %>" Width="300" />
                                <ext:TextField ID="txtTel" runat="server" FieldLabel="<%$Resources:TasinirMal,FRMTFR008 %>" Width="200" />
                                <ext:TextField ID="txtFax" runat="server" FieldLabel="<%$Resources:TasinirMal,FRMTFR009 %>" Width="200" />
                                <ext:TextField ID="txtVNo" runat="server" FieldLabel="<%$Resources:TasinirMal,FRMTFR010 %>" Width="200" />
                                <ext:TextField ID="txtVD" runat="server" FieldLabel="<%$Resources:TasinirMal,FRMTFR011 %>" Width="200" />
                                <ext:TextField ID="txtBanka" runat="server" FieldLabel="<%$Resources:TasinirMal,FRMTFR012 %>" Width="200" />
                                <ext:TextField ID="txtHesapNo" runat="server" FieldLabel="<%$Resources:TasinirMal,FRMTFR013 %>" Width="200" />
                            </Items>
                        </ext:FormPanel>
                    </Items>
                </ext:Panel>
