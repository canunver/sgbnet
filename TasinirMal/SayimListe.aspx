<%@ Page Language="C#" CodeBehind="SayimListe.aspx.cs" Inherits="TasinirMal.SayimListe" %>
        ...
        <ext:Viewport runat="server" StyleSpec="background-color: transparent;" Layout="BorderLayout">
            <Items>
                <ext:PropertyGrid ID="pgFiltre" runat="server" Region="West" ForceFit="true" Collapsible="true"
                    ...
                    <View>
                        <ext:GridView ID="GridView1" ForceFit="true" runat="server" MarkDirty="false" />
                    </View>
                </ext:PropertyGrid>
                        ...
                        <Columns>
                            ...
                            <ext:TemplateColumn ColumnID="BELGENO" DataIndex="BELGENO" Header="Belge No"
                                ...
                                <Template runat="server">
                                    <Html>
                                        <a href="javascript:BelgeAc('{YIL}','{MUHASEBEKOD}','{HARCAMABIRIMIKOD}','{BELGENO}')">{BELGENOSECIM}</a>
                                    </Html>
                                </Template>
                            </ext:TemplateColumn>
