...
namespace TasinirMal
{
    ...
    /// </summary>
    public partial class CetvellerEski : TMMSayfa
    {
        /// <summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["tur"] == "1")
            {
                ...
                divMuhasebe.Attributes.Remove("style");
                divHarcama.Attributes.Remove("style");
            }
            else if (Request.QueryString["tur"] == "2")
            {
                ...
                divMuhasebe.Attributes.Remove("style");
                divHarcama.Attributes.Remove("style");
                divMuhasebeRapor.Attributes.Remove("style");
            }
            else if (Request.QueryString["tur"] == "3")
            {
                formAdi = Resources.TasinirMal.FRMCTV003;
                divIl.Attributes.Remove("style");
                divIlce.Attributes.Remove("style");
            }
            ...
            else if (Request.QueryString["tur"] == "5")
            {
                ...
                divHarcama.Attributes.Remove("style");
                divSeviye.Attributes.Remove("style");
                chkCSV.Visible = true;
            }
            else if (Request.QueryString["tur"] == "6")
            {
                ...
                divIl.Attributes.Remove("style");
                divIlYaziAlan.Attributes.Add("class", "yaziAlanK");
                //divMuhasebe.Attributes.Remove("style");
                //divMuhasebeYaziAlan.Attributes.Add("class", "yaziAlan");
                divHarcama.Attributes.Remove("style");
                divHarcamaYaziAlan.Attributes.Add("class", "yaziAlan");
                imgHarcama.Attributes.Add("onclick", "javascript:ListeAc('ListeHarcamaBirimi.aspx','txtHarcamaBirimi','ddlIl','lblHarcamaBirimiAd');return false;");
            }
            ...
            else if (Request.QueryString["tur"] == "8")
            {
                ...
                divBolge.Attributes.Remove("style");
                divMuhasebe.Attributes.Remove("style");
                divMuhasebeYaziAlan.Attributes.Add("class", "yaziAlan");
                divHarcama.Attributes.Remove("style");
                divHarcamaYaziAlan.Attributes.Add("class", "yaziAlan");
            ...
            this.txtBolge.Attributes.Add("onblur", "kodAdGetir('44','lblBolgeAd',true,new Array('txtBolge'),'KONTROLDENOKU');");
            ...
            if (txtBolge.Text.Trim() != "")
                lblBolgeAd.Text = GenelIslemler.KodAd(44, OrtakFonksiyonlar.ConvertToInt(txtBolge.Text.Trim(), 0).ToString(), true);
            else
                lblBolgeAd.Text = "";
        }

        /// <summary>
        /// Sunucudan il listesini alır ve ddlIl DropDownList kontrolüne doldurur.
        /// Daha sonra, ilçeler doldurulsun diye ddlIl_SelectedIndexChanged yordamını çağırır.
        /// </summary>
        ...
        private Cetvel KriterTopla()
        {
            ...
            {
                kriter.ilKod = ddlIl.SelectedValue;
                kriter.ilceKod = ddlIlce.SelectedValue;
            }
            else if (Request.QueryString["tur"] == "6")
            {
                kriter.ilKod = ddlIl.SelectedValue;
            ...
            {
                kriter.harcamaKod = txtHarcamaBirimi.Text.Trim();
                kriter.seviye = OrtakFonksiyonlar.ConvertToInt(ddlSeviye.SelectedValue, 0);
            }
        ...
        private void TasinirSayimVEYonetimHesabiCetveli(ObjectArray bilgi, string sablonAd)
        {
            ...
            for (int i = 0; i < cetvel.detay.Count; i++)
            {
                ...
                if (!detay.hesapPlanKod.Contains(eskiHesapKod) || string.IsNullOrEmpty(eskiHesapKod))
                {
                    ...
                    XLS.HucreDegerYaz(satir + 2, sutun + 13, ddlYil.SelectedValue.Trim());
        ...
        private void TasinirSayimVEYonetimHesabiCetveliMuhasebe(ObjectArray bilgi, string sablonAd, int yil, string muhasebe, string harcamaBirimKod, Cetvel kriter)
        {
            ...
            for (int i = 0; i < cetvel2.detay.Count; i++)
            {
                ...
                if (siraNo == 1)//Başlık kısmı ilk girişte yazdırılması için
                {
                    ...
                    XLS.HucreDegerYaz(kaynakSatir - 6, sutun + 16, ddlYil.SelectedValue.Trim());
                ...
                //try
                //{
                //    //Kendi birimindekiler
                //    string kharcamaBirimKod = harcamaBirimKod.Replace(".", "");

                //    kharcamaBirimKod = harcamaBirimKod.Replace(".", "");
                //    if (kharcamaBirimKod.Length > 8)
                //    {
                //        //Açılışta kurumsal koda göre tek fiş düzenlendiği için (EGO)
                //        string kosul = yil + "-" + muhasebe + "-" + "" + "-" + detay.hesapPlanKod + "-" + kharcamaBirimKod + "----";
                //        bakiye += servisUZY.UzayDegeriDbl(kullanan, "MUHODEMEEMRIMIF", kosul, true, "");
                //    }
                //    else
                //    {
                //        if (kharcamaBirimKod.Length > 8)
                //            kharcamaBirimKod = kharcamaBirimKod.Substring(8);

                //        string kosul = yil + "-" + muhasebe + "-" + kharcamaBirimKod + "-" + detay.hesapPlanKod + "-----";
                //    }
                //}
                //catch { bakiye = 0; }
                ...
                try
                {
                    ...
                    //string kosul = yil + "-" + muhasebe + "-" + harcamaBirimKod + "-" + detay.hesapPlanKod + "-----";
                    //bakiye = servisUZY.UzayDegeriDbl(kullanan, "MUHODEMEEMRIMIF", kosul, true, "");
                }
                catch { bakiye = 0; }
        ...
        private void TasinirSayimCetveliImzaEkle(Tablo XLS, ref int satir, int sutun, string hesapKodu)
        {
            ...
            XLS.HucreDegerYaz(satir + 1, sutun, string.Format(Resources.TasinirMal.FRMCTV009, ddlYil.SelectedValue.Trim(), "", DateTime.Today.Date.ToShortDateString(), pBirimi));
        ...
        private void MuzeKutuphaneCetveli(Cetvel kriter)
        {
            ...
            for (int i = 0; i < cetvel.detay.Count; i++)
            {
                ...
                if (!detay.hesapPlanKod.Contains(eskiHesapKod) || string.IsNullOrEmpty(eskiHesapKod))
                {
                    ...
                    XLS.HucreDegerYaz(satir + 2, sutun + 18, ddlYil.SelectedValue.Trim());
