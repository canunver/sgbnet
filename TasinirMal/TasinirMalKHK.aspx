<%@ Page Language="C#" CodeBehind="TasinirMalKHK.aspx.cs" Inherits="TasinirMal.TasinirMalKHK" %>
...
<body>
    <form id="form" runat="server">
        ...
        <ext:Viewport ID="Viewport1" runat="server" Layout="BorderLayout" StyleSpec="background-color: transparent;">
            <Items>
                <ext:Panel ID="Panel1" runat="server" Region="Center" Layout="RowLayout" Margins="104 20 10 20">
                    <Items>
                        <ext:FormPanel ID="FormPanel1" runat="server" Height="190" Padding="10" ButtonAlign="Center"
                            AutoScroll="true">
                            <TopBar>
                                <ext:Toolbar ID="Toolbar2" runat="server">
                                    <Items>
                                        ...
                                        <ext:Button ID="btnBelgeYazdir" runat="server" Text="Belge Yazdır" Icon="PageExcel">
                                            <Listeners>
                            ...
                            <Items>
                                ...
                                <ext:TextField runat="server" ID="txtBelgeNo" TabIndex="3" FieldLabel="Fiş No">
                                </ext:TextField>
                            ...
                            <ColumnModel ID="ColumnModel1" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column DataIndex="kdv" Header="KDV" Width="50" Align="Right" Sortable="false"
                                        Hideable="false" />
                                    <ext:Column DataIndex="eBirimFiyat" Header="Eski Birim Fiyat" Width="120" Align="Right"
                                        Sortable="false" Hideable="false">
                                        <Renderer Handler="return Ext1.util.Format.number(value, '0.000,00/i');" />
                                    </ext:Column>
                                    <ext:Column DataIndex="yBirimFiyat" Header="Yeni Birim Fiyat" Width="120" Align="Right"
                                        Sortable="false" Hideable="false">
                                        <Renderer Handler="return Ext1.util.Format.number(value, '0.000,00/i');" />
                                        <Editor>
                                    ...
                                    <Reader>
                                        <ext:ArrayReader IDProperty="kod">
                                            <Fields>
                                                ...
                                                <ext:RecordField Name="eBirimFiyat" />
                                                <ext:RecordField Name="yBirimFiyat" />
                                            </Fields>
                                        </ext:ArrayReader>
                                    </Reader>
                                </ext:Store>
        ...
        <ext:Window ID="wndBilgi" runat="server" PageX="600" PageY="120" Width="260" Height="150"
            ...
            <Items>
                <ext:Label ID="lblInfo" runat="server" Icon="Information" Html="Bu ekrandan sadece KHK kapsamında işlem gören Taşınır İşlem Fişleri ile ilgili işlemler yapabilirsiniz. Daha önce iz bedeli üzerinden girilmiş olan TİF belgesini listeleyip, birim fiyatı <b>Y.Birim Fiyat</b> kolonundan düzelttikten sonra <b>Kaydet</b> işlemi yaparak yeni TİF belgesi üretebilirsiniz.">
                </ext:Label>
            </Items>
        </ext:Window>
    </form>
