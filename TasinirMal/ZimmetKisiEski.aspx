<%@ Page Language="C#" CodeBehind="ZimmetKisiEski.aspx.cs" Inherits="TasinirMal.ZimmetKisiEski" %>
...
<body onunload="HesapPlaniKapat();">
    ...
    <div class="form">
        <div class="row">
            <div class="yaziAlanK">
                <%= Resources.TasinirMal.FRMZKS002 %></div>
            <div class="ikiNokta">
                :</div>
        ...
        <div id="divMHA0" runat="server">
            <div class="row">
                <div class="yaziAlanK">
                    <%= Resources.TasinirMal.FRMZKS003 %></div>
                <div class="ikiNokta">
                    :</div>
                <div class="veriAlan">
                    <asp:TextBox ID="txtMuhasebe" runat="server" CssClass="veriAlan" MaxLength="5" Width="150px"></asp:TextBox></div>
                <div class="veriAlan">
                    <input type="image" alt="<%= Resources.TasinirMal.FRMZKS004 %>" style="height: 14px;
            ...
            <div class="row">
                <div class="yaziAlan">
                    <%= Resources.TasinirMal.FRMZKS005 %></div>
                <div class="ikiNokta">
                    :</div>
                <div class="veriAlan">
                ...
                <div class="veriAlan">
                    <input type="image" alt="<%= Resources.TasinirMal.FRMZKS006 %>" style="height: 14px;
        ...
        <div class="row">
            <div class="yaziAlanK">
                <%= Resources.TasinirMal.FRMZKS007 %></div>
            <div class="ikiNokta">
                :</div>
            <div class="veriAlan">
            ...
            <div class="veriAlan">
                <input type="image" alt="<%= Resources.TasinirMal.FRMZKS008 %>" style="height: 14px;
        ...
        <div class="row">
            <div class="yaziAlan">
                <%= Resources.TasinirMal.FRMZKS009 %></div>
            <div class="ikiNokta">
                :</div>
            <div class="veriAlan">
                <asp:TextBox ID="txtHesapPlanKod" runat="server" CssClass="veriAlan" MaxLength="40"
                    Width="150px"></asp:TextBox></div>
            <div class="veriAlan">
                <input type="image" alt="<%= Resources.TasinirMal.FRMZKS010 %>" style="height: 14px;
    ...
    <asp:Button ID="btnYazdir" TabIndex="99" runat="server" Width="100" CssClass="dugme"
        Text="<%$ Resources:TasinirMal, FRMZKS011 %>" OnClick="btnYazdir_Click"></asp:Button>
    <asp:Button ID="btnListeYazdir" TabIndex="99" runat="server" Width="100" CssClass="dugme"
        Text="<%$ Resources:TasinirMal, FRMZKS012 %>" OnClick="btnListeYazdir_Click"></asp:Button>
