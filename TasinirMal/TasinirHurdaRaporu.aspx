<%@ Page Language="C#" CodeBehind="TasinirHurdaRaporu.aspx.cs" Inherits="TasinirMal.TasinirHurdaRaporu" %>
                    ...
                    <Items>
                        <ext:FormPanel ID="pnlTanim" runat="server" Region="Center" Padding="10" LabelWidth="150">
                            ...
                            <Items>
                                ...
                                <ext:Checkbox ID="chk2Duzey" runat="server" BoxLabel="<%$Resources:TasinirMal,FRMTHU014 %>" />
                            </Items>
                        </ext:FormPanel>
                    </Items>
                </ext:Panel>
