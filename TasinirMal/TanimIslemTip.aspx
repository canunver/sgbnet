<%@ Page Language="C#" CodeBehind="TanimIslemTip.aspx.cs" Inherits="TasinirMal.TanimIslemTip" %>
                ...
                <ext:Panel ID="tabPanelAna" runat="server" Region="Center" StyleSpec="background-color:white;padding:10px"
                    ...
                    <Items>
                        <ext:GridPanel ID="grdListe" runat="server" StripeRows="true" Header="false" TrackMouseOver="true"
                            ...
                            <ColumnModel ID="ColumnModel1" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ColumnID="KOD" DataIndex="KOD" Header="Kod" />
                        ...
                        <ext:FormPanel ID="pnlTanim" runat="server" Region="Center" Padding="10">
                            ...
                            <Items>
                                <ext:TextField ID="txtKod" runat="server" FieldLabel="<%$Resources:TasinirMal,FRMTIT028 %>" Width="100" />
                                <ext:TextField ID="txtAd" runat="server" FieldLabel="<%$Resources:TasinirMal,FRMTIT029 %>" Width="250" />
                                <ext:ComboBox ID="ddlIslemTuru" runat="server" FieldLabel="<%$Resources:TasinirMal,FRMTIT030 %>" QueryMode="Local" Width="250" />
                            </Items>
                        </ext:FormPanel>
                    </Items>
                </ext:Panel>
