<%@ Page Language="C#" CodeBehind="KurusFarkRaporuEski.aspx.cs" Inherits="TasinirMal.KurusFarkRaporuEski" %>
...
<body onunload="HesapPlaniKapat();">
    ...
    <div class="form">
        <div class="row">
            <div class="yaziAlanK">
                <%= Resources.TasinirMal.FRMKFR004 %></div>
            <div class="ikiNokta">
                :</div>
        ...
        <div id="divMHA0" runat="server">
            <div class="row">
                <div class="yaziAlanK">
                    <%= Resources.TasinirMal.FRMKFR005 %></div>
                <div class="ikiNokta">
                    :</div>
                <div class="veriAlan">
                    <asp:TextBox ID="txtMuhasebe" runat="server" CssClass="veriAlan" MaxLength="5" Width="150px"></asp:TextBox></div>
                <div class="veriAlan">
                    <input type="image" alt="<%= Resources.TasinirMal.FRMKFR006 %>" style="height: 14px;
            ...
            <div class="row">
                <div class="yaziAlanK">
                    <%= Resources.TasinirMal.FRMKFR007 %></div>
                <div class="ikiNokta">
                    :</div>
                <div class="veriAlan">
                ...
                <div class="veriAlan">
                    <input type="image" alt="<%= Resources.TasinirMal.FRMKFR008 %>" style="height: 14px;
            ...
            <div class="row">
                <div class="yaziAlan">
                    <%= Resources.TasinirMal.FRMKFR009 %></div>
                <div class="ikiNokta">
                    :</div>
                <div class="veriAlan">
                    <asp:TextBox ID="txtAmbar" runat="server" CssClass="veriAlan" MaxLength="3" Width="150px"></asp:TextBox></div>
                <div class="veriAlan">
                    <input type="image" alt="<%= Resources.TasinirMal.FRMKFR010 %>" style="height: 14px;
        ...
        <div class="row">
            <div class="yaziAlan">
                <%= Resources.TasinirMal.FRMKFR011 %></div>
            <div class="ikiNokta">
                :</div>
            <div class="veriAlan">
                <asp:TextBox ID="txtHesapPlanKod" runat="server" CssClass="veriAlan" MaxLength="40"
                    Width="150px"></asp:TextBox></div>
            <div class="veriAlan">
                <input type="image" alt="<%= Resources.TasinirMal.FRMKFR012 %>" style="height: 14px;
        ...
        <div class="row">
            <div class="yaziAlan">
                <%= Resources.TasinirMal.FRMKFR013 %></div>
            <div class="ikiNokta">
                :</div>
            <div class="veriAlan">
        ...
        <div class="row">
            <div class="yaziAlan">
                <%= Resources.TasinirMal.FRMKFR014 %></div>
            <div class="ikiNokta">
                :</div>
            <div class="veriAlan">
        ...
        <div class="row">
            <div class="yaziAlan">
                <%= Resources.TasinirMal.FRMKFR015 %></div>
            <div class="ikiNokta">
                :</div>
            <div class="veriAlan">
    ...
    <asp:Button ID="btnYazdir" TabIndex="98" runat="server" Width="100" CssClass="dugme"
        Text="<%$ Resources:TasinirMal, FRMKFR016 %>" OnClick="btnYazdir_Click"></asp:Button>
    <asp:Button ID="btnYazdirListe" TabIndex="99" runat="server" Width="100" CssClass="dugme"
        Text="Listele" OnClick="btnYazdirListe_Click"></asp:Button>
