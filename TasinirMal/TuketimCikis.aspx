<%@ Page Language="C#" CodeBehind="TuketimCikis.aspx.cs" Inherits="TasinirMal.TuketimCikis" %>
                    ...
                    <Items>
                        <ext:FormPanel ID="pnlTanim" runat="server" Region="Center" Padding="10" LabelWidth="150">
                            ...
                            <Items>
                                ...
                                <ext:CompositeField runat="server" ID="cmpAmbar">
                                    <Items>
                                ...
                                <ext:Checkbox ID="chkDetay" runat="server" BoxLabel="<%$Resources:TasinirMal,FRMTMC021 %>" />
                            </Items>
                        </ext:FormPanel>
                    </Items>
                </ext:Panel>
