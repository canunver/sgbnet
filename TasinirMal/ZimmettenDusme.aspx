<%@ Page Language="C#" CodeBehind="ZimmettenDusme.aspx.cs" Inherits="TasinirMal.ZimmettenDusme" %>
                    ...
                    <Items>
                        <ext:FormPanel ID="pnlTanim" runat="server" Region="Center" Padding="10" LabelWidth="150">
                            <Items>
                                ...
                                <ext:ComboBox ID="cmbBelgeTuru" runat="server" FieldLabel="Belge Türü" Width="120" >
                                    <SelectedItem Value="1001" />
                                    <Items>
                                        <ext:ListItem Text="Kişi" Value="1001" />
                                        <ext:ListItem Text="Ortak Alan" Value="1003" />
                                    </Items>
                                </ext:ComboBox>
                                <ext:Button ID="btnZimmettenDus" runat="server" Width="120px" Text="Zimmetten Düş" Icon="CartRemove">
                                    <DirectEvents>
                                        <Click OnEvent="btnZimmettenDus_Click">
                                            <EventMask ShowMask="true" MinDelay="20" Msg="Lütfen bekleyin..." />
                                        </Click>
                                    </DirectEvents>
                                </ext:Button>
                                <%--  <ext:Panel ID="frmBilgi" runat="server" Width="400" Header="true" BodyStyle="padding:5px" LabelWidth="150">
                                    <TopBar>
