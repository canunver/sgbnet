<%@ Page Language="C#" CodeBehind="TanimMarka.aspx.cs" Inherits="TasinirMal.TanimMarka" %>
                ...
                <ext:Panel ID="tabPanelAna" runat="server" Region="Center" StyleSpec="background-color:white;padding:10px"
                    ...
                    <Items>
                        ...
                        <ext:FormPanel ID="pnlTanim" runat="server" Region="Center" Padding="10">
                            ...
                            <Items>
                                <ext:TextField ID="txtAd" runat="server" FieldLabel="<%$Resources:TasinirMal,FRMTMA009 %>" Width="200" />
                            </Items>
                        </ext:FormPanel>
                    </Items>
                </ext:Panel>
