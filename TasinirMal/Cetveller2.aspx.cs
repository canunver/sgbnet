...
namespace TasinirMal
{
    ...
    /// </summary>
    public partial class Cetveller2 : TMMSayfaV2
    {
        /// <summary>
        ...
        void RaporDoldur()
        {
            ...
            tipler.Add(new { KOD = "TMM001", AD = "Taşınır Sayım ve Döküm Cetveli (Örnek 13)", DOSYAAD = "xxxx.xlsx" });
            tipler.Add(new { KOD = "TMM002", AD = "Harcama Birimi Taşınır Mal Yönetim Hesabı Cetveli (Örnek 14)", DOSYAAD = "xxxx.xlsx" });
            tipler.Add(new { KOD = "TMM003", AD = "Taşınır Hesap Cetveli (Örnek 15)", DOSYAAD = "xxxx.xlsx" });
            tipler.Add(new { KOD = "TMM004", AD = "İdare Taşınır Mal Yönetimi Ayrıntılı Hesap Cetveli (Örnek 16)", DOSYAAD = "xxxx.xlsx" });
            tipler.Add(new { KOD = "TMM005", AD = "İdare Taşınır Mal Yönetim Hesabı İcmal Cetveli (Örnek 17)", DOSYAAD = "xxxx.xlsx" });
            tipler.Add(new { KOD = "TMM006", AD = "Taşınır Hesap Cetveli (İl) (Örnek 15)", DOSYAAD = "xxxx.xlsx" });
            tipler.Add(new { KOD = "TMM007", AD = "Müze / Kütüphane Yönetim Hesabı Cetveli", DOSYAAD = "xxxx.xlsx" });
            tipler.Add(new { KOD = "TMM008", AD = "Taşınır Hesap Cetveli (Bölge) (Örnek 15)", DOSYAAD = "xxxx.xlsx" });
        ...
        void EkranHazirla(string kod)
        {
            ...
            else if (kod == "TMM002")
            {
                ...
                txtTarih1.Show();
                txtTarih2.Show();
                chkMuhasebeRapor.Show();
                chkBaslik.Show();
                chkBirimGrupluRapor.Show();
            }
            else if (kod == "TMM003")
            {
                ddlIl.Show();
        ...
        protected void btnYazdir_Click(object sender, DirectEventArgs e)
        {
            ...
            if (raporKod == "TMM001")
                TasinirSayimCetveli(KriterTopla(raporKod));
            else if (raporKod == "TMM002")
                TasinirYonetimHesabiCetveli(KriterTopla(raporKod));
            else if (raporKod == "TMM003")
            {
                TasinirHesapCetveli(KriterTopla(raporKod));
            }
            else if (raporKod == "TMM004")
                TasinirKesinHesapCetveli(KriterTopla(raporKod), chkCSV.Checked);
            else if (raporKod == "TMM005")
            {
                TasinirKesinHesapIcmalCetveli(KriterTopla(raporKod), chkCSV.Checked);
            }
            else if (raporKod == "TMM006")
                TasinirHesapCetveliIl(KriterTopla(raporKod));
            else if (raporKod == "TMM007")
                MuzeKutuphaneCetveli(KriterTopla(raporKod));
            else if (raporKod == "TMM008")
                TasinirHesapCetveliBolge(KriterTopla(raporKod));
        }
        /// <summary>
        ...
        private Cetvel KriterTopla(string raporKod)
        {
            ...
            else if (raporKod == "TMM004" || raporKod == "TMM005" || raporKod == "TMM007")
            {
                kriter.harcamaKod = txtHarcamaBirimi.Text.Trim();
        ...
        private void TasinirYonetimHesabiCetveli(Cetvel kriter)
        {
            ...
            {
                if (chkBirimGrupluRapor.Checked)
                    TasinirSayimVEYonetimHesabiCetveliBirimGruplu(bilgi, "TASINIRYONETIMHESABICETVELIBIRIMGRUPLU.xlt");
                else
                {
                    //if (GenelIslemlerIstemci.VarsayilanKurumBul().Replace(".", "") == "1082")
                    //    TasinirYonetimHesabiCetveli1082(bilgi);
                    //else
                    TasinirSayimVEYonetimHesabiCetveli(bilgi, "TASINIRYONETIMHESABICETVELI.xlt");
                }
            }
        ...
        private void TasinirSayimVEYonetimHesabiCetveliBirimGruplu(ObjectArray bilgi, string sablonAd)
        {
            ...
            string harcamaKod = string.Empty;
            string altHesapKod = string.Empty;
            ...
            CetvelDetay harcamaToplam = new CetvelDetay();
            CetvelDetay altHesapToplam = new CetvelDetay();
            ...
            for (int i = 0; i < cetvel.detay.Count; i++)
            {
                ...
                if (i != 0)
                {
                    if (altHesapKod != detay.hesapPlanKod.Substring(0, 6))
                    {
                        satir++;
                        XLS.SatirAc(satir, 1);
                        XLS.HucreKopyala(kaynakSatir, sutun, kaynakSatir, sutun + 14, satir, sutun);

                        DetayYaz(XLS, satir, sutun, -4, altHesapToplam);
                        altHesapToplam = new CetvelDetay();
                        altHesapKod = detay.hesapPlanKod.Substring(0, 6);
                    }
                    ...
                    {
                        if (detay.harcamaKod != harcamaKod)
                        {
                            satir++;
                            XLS.SatirAc(satir, 1);
                            XLS.HucreKopyala(kaynakSatir, sutun, kaynakSatir, sutun + 14, satir, sutun);
                ...
                if (detay.harcamaKod != harcamaKod)// || string.IsNullOrEmpty(harcamaKod))
                                                   //!detay.hesapPlanKod.Contains(eskiHesapKod) 
                {
                    siraNo = 1;
                    satir++;
                    eskiHesapKod = detay.hesapPlanKod.Substring(0, 6);
                    ...
                    if (i != 0)
                    {
                        ...
                        DetayYaz(XLS, satir, sutun, -3, harcamaToplam);
                        harcamaToplam = new CetvelDetay();

                        satir++;

                        TasinirYonetimHesabiCetveliImzaEkle(XLS, ref satir, sutun, false);
                    ...
                    XLS.HucreDegerYaz(satir + 3, sutun + 3, detay.harcamaAd);//cetvel.harcamaAd); 
                    XLS.HucreDegerYaz(satir + 3, sutun + 10, detay.harcamaKod);//cetvel.harcamaKod);
                ...
                //DetayTopla(cd, detay);
                DetayTopla(altHesapToplam, detay);
                DetayTopla(hesapToplam, detay);
                DetayTopla(harcamaToplam, detay);
            ...
            satir++;
            TasinirYonetimHesabiCetveliImzaEkle(XLS, ref satir, sutun, true);
            OrnekNoYaz(XLS, ++satir, sutun, 14);
        ...
        private void TasinirSayimVEYonetimHesabiCetveli(ObjectArray bilgi, string sablonAd)
        {
            ...
            CetvelDetay genelToplam = new CetvelDetay();
            CetvelDetay hesapToplam = new CetvelDetay();
            XLS.HucreAdBulYaz("baslik", "TAŞINIR SAYIM VE DÖKÜM CETVELİ");

            if (sablonAd == "TASINIRYONETIMHESABICETVELI.xlt")
                XLS.HucreAdBulYaz("baslik", "HARCAMA BİRİMİ TAŞINIR MAL YÖNETİM HESABI CETVELİ");
            ...
            for (int i = 0; i < cetvel.detay.Count; i++)
            {
                ...
                if ((!detay.hesapPlanKod.Contains(eskiHesapKod) && !chkBaslik.Checked) || string.IsNullOrEmpty(eskiHesapKod))
                {
                    siraNo = 1;
                    ...
                    if (i != 0)
                    {
                        ...
                        {
                            TasinirSayimCetveliImzaEkle(XLS, ref satir, sutun, eskiHesapKod, false);
            ...
            if (sablonAd == "TASINIRSAYIMCETVELI.xlt")
            {
                TasinirSayimCetveliImzaEkle(XLS, ref satir, sutun, eskiHesapKod, true);
                OrnekNoYaz(XLS, ++satir, sutun, 13);
            }
            else
            {
        ...
        private void TasinirSayimVEYonetimHesabiCetveliMuhasebe(ObjectArray bilgi, string sablonAd, int yil, string muhasebe, string harcamaBirimKod, Cetvel kriter)
        {
            ...
            List<HesapPlaniSatir> kodlar = MuhasebedeKullanilanTasinirKodlariBul(yil, muhasebe, harcamaBirimKod, kriter);
            ...
            foreach (HesapPlaniSatir hM in kodlar)
            {
                bool bulundu = false;

                if (hM.hesapKod.Replace(".", "").StartsWith("2530199"))//EGO Talebi 14 nolu cetvelde gösterilmesin 04.12.2020
                    continue;

                if (kriter.hesapPlanKod != "" && !(hM.hesapKod.StartsWith(kriter.hesapPlanKod))) continue;

                foreach (CetvelDetay cc in cetvel.detay)
                {
                    if (cc.hesapPlanKod.Replace(".", "") == hM.hesapKod.Replace(".", ""))
                    {
                        bulundu = true;
                        break;
                    }
                ...
                if (!bulundu)
                {
                    CetvelDetay cc = new CetvelDetay();
                    cc.hesapPlanKod = hM.hesapKod;
                    cc.hesapPlanAd = hM.hesapKodAciklama;
                    cetvel.detay.Add(cc);
                }
            }
        ...
        private List<HesapPlaniSatir> MuhasebedeKullanilanTasinirKodlariBul(int yil, string muhasebe, string harcamaBirimKod, Cetvel kriter)
        {
            ...
            if (kriter.tarih1.isNull) kriter.tarih1 = new TNSDateTime("01.01." + yil);
            if (kriter.tarih2.isNull) kriter.tarih2 = new TNSDateTime("31.12." + yil);

            oeForm.formDurum = 22;//Bütün Belgeler

            int tur = 3;//İşlem tarihine göre işlem yapsın
            int listeTur = 0;//Para birimi için
            TNS.MUH.MizanBilgi mb = servisMUH.Mizan((TNS.KYM.Kullanici)kullanan, yil, GenelIslemlerIstemci.VarsayilanKurumBul(), oeForm.muhasebe, kBirim, kriter.tarih1, kriter.tarih2, 3, "150", "260", tur, oeForm.fisTur, listeTur, "");
            foreach (TNS.MUH.AnaHesap ml in mb.anaHesaplar.objeler)
            {
                if (ml.hesapKod.StartsWith("150") || ml.hesapKod.StartsWith("253") || ml.hesapKod.StartsWith("254") || ml.hesapKod.StartsWith("255"))
                {
                    foreach (TNS.MUH.HesapBilgi ml2 in ml.detayHesaplar.objeler)
                    {
                        HesapPlaniSatir l = new HesapPlaniSatir();
                        l.hesapKod = ml2.hesapKod;
                        l.hesapKodAciklama = ml2.hesapAd;
        ...
        private void TasinirSayimCetveliImzaEkle(Tablo XLS, ref int satir, int sutun, string hesapKodu, bool sonSayfa)
        {
            if (!sonSayfa && TNS.TMM.Arac.MeclisKullaniyor())
                return;
            ...
            if (TNS.TMM.Arac.MerkezBankasiKullaniyor())
                XLS.HucreDegerYaz(satir + 4, sutun + 10, "DEMİRBAŞ EŞYA SORUMLUSU");
            else
            ...
            XLS.HucreBirlestir(satir, sutun, satir, sutun + 14);
            if (TNS.TMM.Arac.MerkezBankasiKullaniyor())
                XLS.HucreDegerYaz(satir, sutun, "ENVANTER HEYETİ");
            else
        ...
        /// <param name="satir">İmza bilgilerinin yazılmaya başlanacağı satır numarası</param>
        /// <param name="sutun">İmza bilgilerinin yazılmaya başlanacağı sütun numarası</param>
        private void MuzeKutuphaneCetveliImzaEkle(Tablo XLS, ref int satir, int sutun, bool sonSayfa)
        {
            if (!sonSayfa && TNS.TMM.Arac.MeclisKullaniyor())
                return;
        ...
        /// <param name="satir">İmza bilgilerinin yazılmaya başlanacağı satır numarası</param>
        /// <param name="sutun">İmza bilgilerinin yazılmaya başlanacağı sütun numarası</param>
        private void TasinirYonetimHesabiCetveliImzaEkle(Tablo XLS, ref int satir, int sutun, bool sonSayfa)
        {
            if (!sonSayfa && TNS.TMM.Arac.MeclisKullaniyor())
                return;
            ...
            XLS.HucreDegerYaz(satir + 2, sutun + 2, Resources.TasinirMal.FRMCTV022);
            if (TNS.TMM.Arac.MerkezBankasiKullaniyor())
                XLS.HucreDegerYaz(satir + 2, sutun + 2, "DEMİRBAŞ EŞYA KAYIT YETKİLİSİ");
            XLS.HucreDegerYaz(satir + 3, sutun + 2, string.Format(Resources.TasinirMal.FRMCTV011, ad[0]));
            XLS.HucreDegerYaz(satir + 4, sutun + 2, Resources.TasinirMal.FRMGAG007);
            ...
            if (TNS.TMM.Arac.MerkezBankasiKullaniyor())
                XLS.HucreDegerYaz(satir + 2, sutun + 6, "DEMİRBAŞ EŞYA KONTROL YETKİLİSİ");
            ...
            {
                XLS.HucreDegerYaz(satir + 7, sutun + 6, "BİRİM YETKİLİSİ\r(Fakülte Dekanı/Enstitü Müdürü/Yüksekokul Müdürü/Merkez Müdürü/Genel Sekreter/Daire Başkanı)");
            }
            else
        ...
        private void DetayYaz(Tablo XLS, int satir, int sutun, int siraNo, CetvelDetay detay)
        {
            ...
            else
            {
                ...
                if (siraNo == 0)
                    ...
                    XLS.HucreDegerYaz(satir, sutun, "HARCAMA BİRİMİ TOPLAMI");
                else if (siraNo == -4)
                    XLS.HucreDegerYaz(satir, sutun, "EKOD TOPLAMI");
        ...
        private void TasinirHesapCetveli(Cetvel kriter)
        {
                ...
                for (int i = 0; i < cetvel.detay.Count; i++)
                {
                    ...
                    if (eskiCetvel.ilKod != cetvel.ilKod || eskiCetvel.ilceKod != cetvel.ilceKod || !detay.hesapPlanKod.Contains(eskiHesapKod) || string.IsNullOrEmpty(eskiHesapKod))
                    {
                        if (!string.IsNullOrEmpty(eskiCetvel.ilKod))
                        {
                            ...
                            TasinirHesapCetveliImzaEkle(XLS, ref satir, sutun, false);
            ...
            TasinirHesapCetveliImzaEkle(XLS, ref satir, sutun, true);
            OrnekNoYaz(XLS, ++satir, sutun, 15);
        ...
        /// <param name="satir">İmza bilgilerinin yazılmaya başlanacağı satır numarası</param>
        /// <param name="sutun">İmza bilgilerinin yazılmaya başlanacağı sütun numarası</param>
        private void TasinirHesapCetveliImzaEkle(Tablo XLS, ref int satir, int sutun, bool sonSayfa)
        {
            if (!sonSayfa && TNS.TMM.Arac.MeclisKullaniyor())
                return;
        ...
        private void TasinirKesinHesapCetveli(Cetvel kriter, bool csvFormati)
        {
            ...
            for (int i = 0; i < cetvel.detay.Count; i++)
            {
                ...
                if ((!detay.hesapPlanKod.Contains(eskiHesapKod) && !chkBaslik.Checked) || string.IsNullOrEmpty(eskiHesapKod))
                {
                    ...
                    if (i != 0)
                    {
                        ...
                        TasinirKesinHesapCetveliImzaEkle(XLS, ref satir, sutun, false);
            ...
            TasinirKesinHesapCetveliImzaEkle(XLS, ref satir, sutun, true);
            OrnekNoYaz(XLS, ++satir, sutun, 16);
        ...
        private void MuzeKutuphaneCetveli(Cetvel kriter)
        {
            ...
            for (int i = 0; i < cetvel.detay.Count; i++)
            {
                ...
                if (!detay.hesapPlanKod.Contains(eskiHesapKod) || string.IsNullOrEmpty(eskiHesapKod))
                {
                    ...
                    if (i != 0)
                    {
                        ...
                        MuzeKutuphaneCetveliImzaEkle(XLS, ref satir, sutun, false);
            ...
            MuzeKutuphaneCetveliImzaEkle(XLS, ref satir, sutun, true);
            OrnekNoYaz(XLS, ++satir, sutun, 18);
        ...
        private void TasinirKesinHesapIcmalCetveli(Cetvel kriter, bool csvFormati)
        {
            ...
            for (int i = 0; i < cetvel.detay.Count; i++)
            {
                ...
                if ((!detay.hesapPlanKod.Contains(eskiHesapKod) && !chkBaslik.Checked) || string.IsNullOrEmpty(eskiHesapKod))
                {
                    if (i != 0)
                    {
                        ...
                        TasinirKesinHesapIcmalCetveliImzaEkle(XLS, ref satir, sutun, false);
            ...
            TasinirKesinHesapIcmalCetveliImzaEkle(XLS, ref satir, sutun, true);
            OrnekNoYaz(XLS, ++satir, sutun, 17);
        ...
        /// <param name="satir">İmza bilgilerinin yazılmaya başlanacağı satır numarası</param>
        /// <param name="sutun">İmza bilgilerinin yazılmaya başlanacağı sütun numarası</param>
        private void TasinirKesinHesapCetveliImzaEkle(Tablo XLS, ref int satir, int sutun, bool sonSayfa)
        {
            if (!sonSayfa && TNS.TMM.Arac.MeclisKullaniyor())
                return;
        ...
        /// <param name="satir">İmza bilgilerinin yazılmaya başlanacağı satır numarası</param>
        /// <param name="sutun">İmza bilgilerinin yazılmaya başlanacağı sütun numarası</param>
        private void TasinirKesinHesapIcmalCetveliImzaEkle(Tablo XLS, ref int satir, int sutun, bool sonSayfa)
        {
            if (!sonSayfa && TNS.TMM.Arac.MeclisKullaniyor())
                return;
