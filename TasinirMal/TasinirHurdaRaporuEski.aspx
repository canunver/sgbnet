<%@ Page Language="C#" CodeBehind="TasinirHurdaRaporuEski.aspx.cs" Inherits="TasinirMal.TasinirHurdaRaporuEski" %>
...
<body onunload="HesapPlaniKapat();">
    ...
    <div class="form">
        <div class="row">
            <div class="yaziAlanK">
                <%= Resources.TasinirMal.FRMTHU003 %></div>
            <div class="ikiNokta">
                :</div>
        ...
        <div id="divMHA0" runat="server">
            <div class="row">
                <div class="yaziAlanK">
                    <%= Resources.TasinirMal.FRMTHU004 %></div>
                <div class="ikiNokta">
                    :</div>
                <div class="veriAlan">
                    <asp:TextBox ID="txtMuhasebe" runat="server" CssClass="veriAlan" MaxLength="5" Width="100px"></asp:TextBox></div>
                <div class="veriAlan">
                    <input type="image" alt="<%= Resources.TasinirMal.FRMTHU005 %>" style="height: 14px;
            ...
            <div class="row">
                <div class="yaziAlan">
                    <%= Resources.TasinirMal.FRMTHU006 %></div>
                <div class="ikiNokta">
                    :</div>
                <div class="veriAlan">
                ...
                <div class="veriAlan">
                    <input type="image" alt="<%= Resources.TasinirMal.FRMTHU007 %>" style="height: 14px;
            ...
            <div class="row">
                <div class="yaziAlan">
                    <%= Resources.TasinirMal.FRMTHU008 %></div>
                <div class="ikiNokta">
                    :</div>
                <div class="veriAlan">
                    <asp:TextBox ID="txtAmbar" runat="server" CssClass="veriAlan" MaxLength="3" Width="100px"></asp:TextBox></div>
                <div class="veriAlan">
                    <input type="image" alt="<%= Resources.TasinirMal.FRMTHU009 %>" style="height: 14px;
        ...
        <div class="row">
            <div class="yaziAlan">
                <%= Resources.TasinirMal.FRMTHU010 %></div>
            <div class="ikiNokta">
                :</div>
        ...
        <div class="row">
            <div class="yaziAlan">
                <%= Resources.TasinirMal.FRMTHU011 %></div>
            <div class="ikiNokta">
                :</div>
            <div class="veriAlan">
        ...
        <div class="row">
            <div class="yaziAlan">
                <%= Resources.TasinirMal.FRMTHU012 %></div>
            <div class="ikiNokta">
                :</div>
            <div class="veriAlan">
            ...
            <div class="veriAlan">
                <input type="image" alt="<%= Resources.TasinirMal.FRMTHU013 %>" style="height: 14px;
        ...
        <div class="row">
            <div class="yaziAlan">
                <%= Resources.TasinirMal.FRMTHU014 %></div>
            <div class="ikiNokta">
                :</div>
            <div class="veriAlan">
    ...
    <asp:Button ID="btnYazdir" TabIndex="99" OnClick="btnYazdir_Click" runat="server"
        Width="100" CssClass="dugme" Text="<%$ Resources:TasinirMal, FRMTHU015 %>"></asp:Button>
