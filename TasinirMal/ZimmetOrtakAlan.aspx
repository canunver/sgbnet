<%@ Page Language="C#" CodeBehind="ZimmetOrtakAlan.aspx.cs" Inherits="TasinirMal.ZimmetOrtakAlan" %>
                    ...
                    <Items>
                        <ext:FormPanel ID="pnlTanim" runat="server" Region="Center" Padding="10" LabelWidth="150">
                            ...
                            <Items>
                                ...
                                <ext:Checkbox ID="chkKisiDahilEt" runat="server" BoxLabel="<%$Resources:TasinirMal,FRMZOA011 %>" />
                            </Items>
                        </ext:FormPanel>
                    </Items>
                </ext:Panel>
