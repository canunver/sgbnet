<%@ Page Language="C#" CodeBehind="ListeMarka.aspx.cs" Inherits="TasinirMal.ListeMarka" EnableViewState="false" %>

<%@ Register Assembly="Ext1.Net" Namespace="Ext1.Net" TagPrefix="ext" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title><%= Resources.TasinirMal.FRMLMA001 %></title>
    <script language="JavaScript" type="text/javascript">
        //Yeni marka linki eklenecek
        ...
        <ext:Viewport runat="server" StyleSpec="background-color: transparent;" Layout="BorderLayout">
            <Items>
                <ext:GridPanel ID="grdListe" runat="server" StripeRows="true" Header="false" TrackMouseOver="true"
                    Border="true" StoreID="strListe" Region="Center" Split="true" AutoExpandColumn="ADI" Cls="gridExt">
                    <TopBar>
