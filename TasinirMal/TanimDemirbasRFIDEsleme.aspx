<%@ Page Language="C#" CodeBehind="TanimDemirbasRFIDEsleme.aspx.cs" Inherits="TasinirMal.TanimDemirbasRFIDEsleme" %>
                    ...
                    <Items>
                        ...
                        <ext:GridPanel ID="grdListe" runat="server" Region="Center" StripeRows="true" StoreID="strListe"
                            ...
                            <TopBar>
                                <ext:Toolbar runat="server">
                                    <Items>
                                        <ext:Button runat="server" Text="Kaydet" Icon="Disk">
                                            <DirectEvents>
                                                <Click OnEvent="btnKaydet_Click">
                                                    <ExtraParams>
                                                        <ext:Parameter Name="SATIRLAR" Value="Ext1.util.JSON.encode(#{gvSicilNo}.getRowsValues())"
                                                            Mode="Raw" />
                                                    </ExtraParams>
                                                    <EventMask ShowMask="true" MinDelay="20" Msg="Lütfen bekleyin..." />
                                                </Click>
                            ...
                            <ColumnModel ID="ColumnModel1" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ColumnID="prSicilNo" DataIndex="prSicilNo" Align="Left" Hidden="true" />
                                    ...
                                    <ext:Column ColumnID="kimeGitti" DataIndex="kimeGitti" Header="<%$ Resources:TasinirMal, FRMBRK040 %>" Align="Left" Width="160" Hidden="true" />
