<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TasinirIstekKarsilanma.aspx.cs"
    Inherits="TasinirMal.TasinirIstekKarsilanma" %>
...
<body onunload="HesapPlaniKapat();">
    ...
    <div class="form">
        <div class="row">
            <div class="yaziAlanK">
                <%= Resources.TasinirMal.FRMIKF004 %></div>
            <div class="ikiNokta">
                :</div>
        ...
        <div id="divMHA0" runat="server">
            <div class="row">
                <div class="yaziAlanK">
                    <%= Resources.TasinirMal.FRMIKF005 %></div>
                <div class="ikiNokta">
                    :</div>
                <div class="veriAlan">
                    <asp:TextBox ID="txtMuhasebe" runat="server" CssClass="veriAlan" MaxLength="5" Width="150px"></asp:TextBox></div>
                <div class="veriAlan">
                    <input type="image" alt="<%= Resources.TasinirMal.FRMIKF006 %>" style="height: 14px;
            ...
            <div class="row">
                <div class="yaziAlan">
                    <%= Resources.TasinirMal.FRMIKF007 %></div>
                <div class="ikiNokta">
                    :</div>
                <div class="veriAlan">
                ...
                <div class="veriAlan">
                    <input type="image" alt="<%= Resources.TasinirMal.FRMIKF008 %>" style="height: 14px;
        ...
        <div class="row">
            <div class="yaziAlan">
                <%= Resources.TasinirMal.FRMIKF009 %></div>
            <div class="ikiNokta">
                :</div>
            <div class="veriAlan">
            ...
            <div class="veriAlan">
                <input type="image" alt="<%= Resources.TasinirMal.FRMIKF010 %>" style="height: 14px;
        ...
        <div class="row">
            <div class="yaziAlan">
                <%= Resources.TasinirMal.FRMIKF011 %></div>
            <div class="ikiNokta">
                :</div>
            ...
            <div class="yaziAlan">
                <%= Resources.TasinirMal.FRMIKF012 %></div>
            <div class="ikiNokta">
                :</div>
            <div class="veriAlan" style="width: 250px;">
    ...
    <asp:Button ID="btnYazdir" TabIndex="99" runat="server" Width="100" CssClass="dugme"
        Text="<%$ Resources:TasinirMal, FRMIKF013 %>" OnClick="btnYazdir_Click"></asp:Button>
